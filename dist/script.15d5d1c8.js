...
})({"8a79816518386d8929231cf1176024f4":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "15d5d1c8a45c9c59659546b883c401d0";
...
exports.controlInitialDataReturn = controlInitialDataReturn;
exports.chooseSong = chooseSong;
exports.defineNextSong = defineNextSong;
exports.definePrevSong = definePrevSong;
exports.playAudio = playAudio;
exports.pauseAudio = pauseAudio;
exports.handleClickAudioPlay = handleClickAudioPlay;
exports.nextSong = nextSong;
exports.prevSong = prevSong;
exports.currentSong = exports.playAudioStatus = void 0;
...
var _renderListOfArtists = require("./views/renderListOfArtists");

const playAudioStatus = {
  play: false
};
exports.playAudioStatus = playAudioStatus;
const currentSong = {
  current: 0,
  list: false,
  slideOpen: false
...
async function controlPlayListOnInput(e) {
  e.preventDefault();
  const value = _config.searchField.value;
  const response = await (0, _model.getDataFromApi)(_model.data, value.toLowerCase());
  const {
    newData
  } = response;
  _config.searchField.value = '';

  _config.closeIcon.classList.remove('closeIcon--active');

  (0, _renderListOfArtists.renderSlides)([...newData.artist].reverse());
}

_config.searchForm.addEventListener('submit', controlPlayListOnInput);

_config.audio.addEventListener('ended', _renderListOfArtists.stopDiscRotation);

async function controlInitialDataReturn(url1, url2) {
  const {
    artistTop,
    artistAllTracks
  } = await (0, _model.getTopTrack)(_model.data, url1, url2);
  (0, _renderListOfArtists.renderListOfArtists)(artistTop);
  (0, _renderListOfArtists.musicSwitcher)(artistTop);
  (0, _model.setAudioAttr)(artistTop, currentSong.current);

  _config.artistTrackList.addEventListener('click', e => {
    currentSong.list = true;
    e.preventDefault();
    (0, _renderListOfArtists.renderListOfArtists)(artistAllTracks);
    (0, _renderListOfArtists.musicSwitcher)(artistAllTracks);
    (0, _model.setAudioAttr)(artistAllTracks, currentSong.current);
    (0, _renderListOfArtists.stopDiscRotation)();
  });

  chooseSong(artistTop, artistAllTracks);
}

controlInitialDataReturn(_config.API_TOP_URL, _config.API_TRACKLIST);

function chooseSong(artistTop, artistAllTracks) {
  _config.next.addEventListener('click', () => {
    defineNextSong(currentSong, artistTop, artistAllTracks);
  });

  _config.prev.addEventListener('click', () => {
    definePrevSong(currentSong, artistTop, artistAllTracks);
  });

  _config.audio.addEventListener('ended', function () {
    setTimeout(() => {
      defineNextSong(currentSong, artistTop, artistAllTracks);
    }, 800);
  });
...
function defineNextSong(obj, listTop, listAll) {
  return obj.list ? nextSong(obj, listAll) : nextSong(obj, listTop);
}

function definePrevSong(obj, listTop, listAll) {
...
function playAudio() {
  ...
  (0, _renderListOfArtists.renderDiscRotation)();
...
function handleClickAudioPlay(e) {
...
function handleClickPogressBar(e) {
  ...
  _config.audio.currentTime = time;
}

function nextSong(obj, data) {
  obj.current++;
  ...
  (0, _model.setAudioAttr)(data, obj.current);
...
},{"../internals/export":"10044f24ecae4059b4af184e71d3fba2"}],"09212d541c5c40ff2bd93475a904f8de":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.API_TRACKLIST = exports.API_TOP_URL = exports.CORS_S = exports.API_URL = exports.random = exports.artistsPreloadArr = exports.currentSlide = exports.closeIcon = exports.audioIcon = exports.btnSet = exports.slideContainer = exports.artistTrackList = exports.trackList = exports.prev = exports.next = exports.trackAlbum = exports.artistTrack = exports.artistName = exports.audio = exports.discContainer = exports.discContainerBox = exports.listArtistsItem = exports.listArtists = exports.collection = exports.searchField = exports.searchForm = exports.playerContainer = exports.searchBlock = exports.container = void 0;
const container = document.querySelector('.container');
exports.container = container;
const [searchBlock, playerContainer] = Array.from(container.children);
exports.playerContainer = playerContainer;
exports.searchBlock = searchBlock;
const searchForm = searchBlock.querySelector('.searchForm');
exports.searchForm = searchForm;
const searchField = searchForm.querySelector('.searchField');
exports.searchField = searchField;
const collection = document.querySelector('.collection');
exports.collection = collection;
const listArtists = collection.querySelector('.listArtists');
exports.listArtists = listArtists;
const listArtistsItem = listArtists.querySelectorAll('.listArtists__item');
exports.listArtistsItem = listArtistsItem;
const discContainerBox = collection.querySelector('.discContainer-box');
exports.discContainerBox = discContainerBox;
const discContainer = discContainerBox.querySelector('.discContainer');
exports.discContainer = discContainer;
const audio = document.querySelector('audio');
exports.audio = audio;
const artistName = collection.querySelector('.artistInfo__name');
exports.artistName = artistName;
const artistTrack = collection.querySelector('.artistInfo__track');
exports.artistTrack = artistTrack;
const trackAlbum = collection.querySelector('.artistInfo__album');
exports.trackAlbum = trackAlbum;
const next = collection.querySelector('.btnSet__next');
exports.next = next;
const prev = collection.querySelector('.btnSet__prev');
exports.prev = prev;
const trackList = collection.querySelector('.openTrackList');
exports.trackList = trackList;
const artistTrackList = trackList.children[0];
exports.artistTrackList = artistTrackList;
const slideContainer = container.querySelector('.slideContainer');
exports.slideContainer = slideContainer;
const btnSet = document.querySelector('.btnSet');
exports.btnSet = btnSet;
const audioIcon = btnSet.querySelector('.audioIcon');
exports.audioIcon = audioIcon;
const closeIcon = searchBlock.querySelector('.closeIcon');
exports.closeIcon = closeIcon;
const currentSlide = {
  slide: 0
};
exports.currentSlide = currentSlide;
const artistsPreloadArr = [13, 412, 47, 25, 81, 4, 52, 1, 8706544, 1678249, 92, 163, 11, 2, 3, 7, 8, 9, 14, 17, 7890702, 27];
exports.artistsPreloadArr = artistsPreloadArr;
const random = Math.floor(Math.random() * artistsPreloadArr.length);
exports.random = random;
const API_URL = 'https://cors-anywhere.herokuapp.com/https://api.deezer.com/search/artist?q=';
exports.API_URL = API_URL;
const CORS_S = 'https://cors-anywhere.herokuapp.com/';
exports.CORS_S = CORS_S;
const API_TOP_URL = `https://cors-anywhere.herokuapp.com/https://api.deezer.com/artist/${artistsPreloadArr[random]}/top`;
exports.API_TOP_URL = API_TOP_URL;
const API_TRACKLIST = `https://cors-anywhere.herokuapp.com/https://api.deezer.com/artist/${artistsPreloadArr[random]}/top?limit=15`;
exports.API_TRACKLIST = API_TRACKLIST;
...
exports.getDataInputChange = getDataInputChange;
exports.currentSongMarker = currentSongMarker;
exports.setAudioAttr = setAudioAttr;
exports.closeInputValue = closeInputValue;
exports.data = void 0;
...
async function getDataFromApi(data, value) {
  const apiData = await (0, _helpers.getJSON)(`${_config.API_URL}${value}`);
  const newData = { ...data
  };
...
async function getTopTrack(data, urlTop, urlList) {
  const newData = { ...data
  };
  const [topFive, artistTrackList] = await Promise.all([await (0, _helpers.getJSON)(urlTop), await (0, _helpers.getJSON)(urlList)]);
  topFive.data.forEach(item => {
    newData.artistTop = [...newData.artistTop, {
      id: item.artist.id,
  ...
  artistTrackList.data.forEach(item => {
    newData.artistAllTracks = [...newData.artistAllTracks, {
      id: item.artist.id,
      album: item.album.title,
      albumCover: item.album.cover_medium,
      name: item.artist.name,
...
async function getDataInputChange(data) {}

getDataInputChange(data);

function currentSongMarker(current) {
...
function setAudioAttr(artist, current) {
  const newArtistList = [...artist];

  _config.audio.setAttribute('src', newArtistList[current].track);

  _config.discContainer.style.background = `url("${newArtistList[current].albumCover}")`;
  _config.artistName.textContent = `${newArtistList[current].name}`;
...
function closeInputValue() {
  _config.closeIcon.classList.add('closeIcon--active');

  _config.closeIcon.addEventListener('click', () => {
    this.value = '';

    _config.closeIcon.classList.remove('closeIcon--active');
  });
}
},{"regenerator-runtime":"e155e0d3930b156f86c48e8d05522b16","./config":"09212d541c5c40ff2bd93475a904f8de","./helpers":"0e8dcd8a4e1c61cf18f78e1c2563655d","./script":"6c63e38e00ac7926ca031d71e364a4c8"}],"e155e0d3930b156f86c48e8d05522b16":[function(require,module,exports) {
/**
...
},{"regenerator-runtime":"e155e0d3930b156f86c48e8d05522b16"}],"375e15a6d42ddfacf1ca41170d8fd28d":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderListOfArtists = renderListOfArtists;
exports.musicSwitcher = musicSwitcher;
exports.renderGrid = renderGrid;
exports.renderArtistTrackList = renderArtistTrackList;
exports.renderDiscRotation = renderDiscRotation;
exports.stopDiscRotation = stopDiscRotation;
...
function renderListOfArtists(data) {
  if (data) {
    _config.listArtists.innerHTML = '';
    [...data].reverse().forEach(item => {
      ...
      _config.listArtists.insertAdjacentHTML('afterbegin', markUp);
...
function musicSwitcher(artist) {
  const listItems = document.querySelectorAll('.listArtists__item');
  listItems.forEach((item, i) => {
    item.addEventListener('click', function () {
      _config.audio.setAttribute('src', artist[i].track);

      _config.discContainer.style.background = `url("${artist[i].albumCover}")`;
      _config.artistName.textContent = `${artist[i].name}`;
      _config.artistTrack.textContent = `${artist[i].trackTitle}`;
      _config.trackAlbum.textContent = `From the album: ${artist[i].album}`;
      _script.currentSong.current = i;
      (0, _model.currentSongMarker)(_script.currentSong.current);
      stopDiscRotation();
      setTimeout(() => {
        (0, _script.playAudio)();
      }, 500);
...
function renderGrid() {
  _config.collection.classList.add('collection--active');

  _config.listArtists.classList.add('listArtists--active');
}

function renderArtistTrackList(data) {
  _config.artistTrackList.textContent = `More from ${data}`;
}

function renderDiscRotation() {
  _config.discContainerBox.classList.add('discContainerBox--active');
}

function stopDiscRotation() {
  _config.discContainerBox.classList.remove('discContainerBox--active');
}

function renderSlides(artist) {
  ...
  const slides = _config.slideContainer.querySelectorAll('.slide');
...
function getDataFromSlide(slides, artist) {
  slides.forEach((item, i) => {
    item.addEventListener('click', () => {
      _config.slideContainer.classList.remove('slideContainer--active');

      const urlTop = `${_config.CORS_S}${artist[i].trackList.replace('limit=50', 'limit=5')}`;
      const urlAllTracks = `${_config.CORS_S}${artist[i].trackList.replace('limit=50', 'limit=15')}`;
      (0, _script.controlInitialDataReturn)(urlTop, urlAllTracks);
    });
  });
}

document.body.addEventListener('click', handleSlidePosition);
},{"../config":"09212d541c5c40ff2bd93475a904f8de","../script":"6c63e38e00ac7926ca031d71e364a4c8","../model":"aabf248f40f7693ef84a0cb99f385d1f"}]},{},["8a79816518386d8929231cf1176024f4","6c63e38e00ac7926ca031d71e364a4c8"], null)

//# sourceMappingURL=script.15d5d1c8.js.map
